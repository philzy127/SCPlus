	...
	public function render_fields_selector() {
		...
		<div class="scp-utm-container">
			...
			<div class="scp-utm-buttons">
				...
				<button type="button" class="button" id="scp_utm_remove_all" title="<?php esc_attr_e( 'Remove All', 'supportcandy-plus' ); ?>"><span class="dashicons dashicons-undo"></span></button>
			</div>
			<div class="scp-utm-box">
